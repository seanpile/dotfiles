...
vim.keymap.set("n", "<C-n>", "<cmd>cnext<CR>", { desc = "Go to previous Diagnostic message" })
vim.keymap.set("n", "<C-p>", "<cmd>cprev<CR>", { desc = "Go to next Diagnostic message" })
...
vim.keymap.set("n", "<leader>zz", ":e ~/.config/nvim-kickstart/init.lua<CR>", { desc = "Edit nvim configuration" })
...
require("lazy").setup({
	...
	-- kitty-navigator; navigate between splits
	"knubie/vim-kitty-navigator",

	-- Indent style detection
	"nmac427/guess-indent.nvim",

	-- Open to last position when opening files
	"farmergreg/vim-lastplace",

	-- Basic git integration
	"tpope/vim-fugitive",

	-- Better file navigating
	{
		"jeetsukumaran/vim-filebeagle",
		config = function()
			vim.keymap.set("n", "-", ":FileBeagleBufferDir<CR>")
			vim.keymap.set("n", "_", ":FileBeagle<CR>")
		end,
	},
	...
	-- comment.nvim; gc to comment regions
	...
	{ -- Useful plugin to show you pending keybinds.
		...
		config = function() -- This is the function that runs, AFTER loading
			...
			require("which-key").register({
				...
				["<leader>p"] = { name = "[P]roject Search", _ = "which_key_ignore" },
				["<leader>w"] = { name = "[W]orkspace", _ = "which_key_ignore" },
				["<leader>t"] = { name = "[T]oggle", _ = "which_key_ignore" },
				["<leader>h"] = { name = "Git [H]unk", _ = "which_key_ignore" },
				["<leader>z"] = { name = "Configuration", _ = "which_key_ignore" },
				["<leader>s"] = { name = "[S]ave file", _ = "which_key_ignore" },
			})
			-- visual mode
			require("which-key").register({
				["<leader>h"] = { "Git [H]unk" },
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			require("telescope").setup({
				defaults = {
					file_ignore_patterns = { "vendor/.*", "node%_modules/.*" },
					mappings = {
						i = {
	...
	{ -- Collection of various small independent plugins/modules
		...
		config = function()
			...
			bufremove.setup()
			vim.keymap.set("n", "<leader><bs>", bufremove.unshow_in_window, { desc = "Unshow buffer in window" })
		end,
	},

	{
		...
		config = function()
			...
			vim.g.lightline = {
				...
				component_expand = {
					lineinfo = "lightline#lineinfo#percent",
